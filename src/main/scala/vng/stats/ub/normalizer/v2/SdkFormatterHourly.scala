...
object SdkFormatterHourly {
    ...
    def accRegisterFormatter(logDate: String, gameCode: String, sc: SparkContext): Unit = {
        ...
        var path2 = Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.LOGIN_LOGOUT_OUTPUT_FOLDER, logDate)
        ...
        var totalPath1=Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.TOTAL_ACC_LOGIN_OUTPUT_FOLDER, dateBeforeOneDay)
        var totalPath2=Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.TOTAL_ACC_LOGIN_OUTPUT_FOLDER, logDate)
        formatter.setOutputPath(Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.ACC_REGISTER_OUTPUT_FOLDER, logDate))
        formatter.setTotalAccBeforeOutputFolder(totalPath1)
        formatter.setTotalAccOutputFolder(totalPath2)
        formatter.format(sc)
    ...
    def firstChargeFormatter(logDate: String, gameCode: String, sc: SparkContext): Unit = {
        ...
        var path2 = Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.PAYMENT_OUTPUT_FOLDER, logDate)
        ...
        var totalPath1=Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.TOTAL_ACC_PAID_OUTPUT_FOLDER, dateBeforeOneDay)
        var totalPath2=Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.TOTAL_ACC_PAID_OUTPUT_FOLDER, logDate)
        formatter.setOutputPath(Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.FIRST_CHARGE_OUTPUT_FOLDER, logDate))
        formatter.setTotalAccBeforeOutputFolder(totalPath1)
        formatter.setTotalAccOutputFolder(totalPath2)
    ...
    def loginFormatter(logDate: String, gameCode: String, sc: SparkContext): Unit = {
        ...
        val pathList1 = DataUtils.getMultiSdkLogFilesHourly(path1, logDate, fileName, 1) // tuonglv - 2016-09-07: change 0 to 1
        ...
        formatter.setOutputPath(Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.LOGIN_LOGOUT_OUTPUT_FOLDER, logDate))
        formatter.format(sc)
    ...
    def paymentFormatter(logDate: String, gameCode: String, sc: SparkContext): Unit = {
        ...
        val pathList1 = DataUtils.getMultiSdkLogFilesHourly(path, logDate, fileName1, 1) // tuonglv - 2016-09-07: change 0 to 1

        val fileName2 = Common.getGameCodeInFileName(gameCode,"loginlogout").toUpperCase  + "_Login_InfoLog"
        val pathList2 = DataUtils.getMultiSdkLogFilesHourly(path, logDate, fileName2, 1) // tuonglv - 2016-09-07: keep 1
        ...
        formatter.setOutputPath(Common.getHourlyOutputParquetPath(gameCode, Constants.PARQUET_2.PAYMENT_OUTPUT_FOLDER, logDate))
        formatter.format(sc)

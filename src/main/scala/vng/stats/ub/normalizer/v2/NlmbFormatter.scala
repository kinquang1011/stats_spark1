...
object NlmbFormatter extends IngameFormatter("nlmb", "nlmb") {
    ...
    override def loginLogoutFormatter(logDate: String, sc: SparkContext): Unit = {
        ...
        var loginPath = Common.getInputParquetPath("coccm", "login")
        var logoutPath = Common.getInputParquetPath("coccm", "logout")
    ...
    override def paymentFormatter(logDate: String, sc: SparkContext): Unit = {
        ...
        var paymentPath = Common.getInputParquetPath("coccm", "recharge")

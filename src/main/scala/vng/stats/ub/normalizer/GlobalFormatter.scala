...
object GlobalFormatter {
    ...
    def convertFormatter(logDate: String, sc: SparkContext): Unit = {
        ...
        // zingxu_convert file
        val fwZingxuConvertFile = Common.getRawInputPath(gameCode, YMD, "FW2", "ZingXuConvert", "FW_ZingXuConvert_" + YMD + ".csv.gz")
        val prevZingxuConvertFile = Common.getRawInputPath(gameCode, prevYMD, "FW2", "ZingXuConvert", "FW_ZingXuConvert_" + prevYMD + ".csv.gz")
        
        // zingxu_convert_detail
        val fwZingxuConvertDetailFile = Common.getRawInputPath(gameCode, YMD, "FW2", "ZingXuConvertDetail", "ZingXuConvertDetail_" + YMD + ".csv.gz")
        val prevZingxuConvertDetailFile = Common.getRawInputPath(gameCode, prevYMD, "FW2", "ZingXuConvertDetail", "ZingXuConvertDetail_" + prevYMD + ".csv.gz")
        ...
        // payment channel
        val channelFile = Common.getRawInputPath(gameCode, YMD, "FW2", "PMC", "PaymentChannel_" + YMD + ".csv.gz")
    ...
    def firstChargeFormatter(logDate: String, sc: SparkContext): Unit = {
        ...
        val fwFirstChargeFile = Common.getRawInputPath(gameCode, YMD, "FW2", "FirstCharge", "FW_FirstCharge_" + YMD + ".csv.gz")
        val prevFwFirstChargeFile = Common.getRawInputPath(gameCode, prevYMD, "FW2", "FirstCharge", "FW_FirstCharge_" + prevYMD + ".csv.gz")
